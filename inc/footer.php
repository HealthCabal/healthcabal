<footer class="xs-footer-section footer-style3" style="margin-top:50px">
                ...
                <div class="col-md-6">
                    <div class="copyright-content">
                        <ul class="social-list version-2">
                            <li><a href="https://web.facebook.com/Healthcabal" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="https://twitter.com/healthcabal" target="_blank" class="twitter"><i class="fa fa-twitter"></i></a></li>
